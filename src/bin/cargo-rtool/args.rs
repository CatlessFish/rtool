...
/// returns false for some special crate types that can't be handled by rtool.
/// For example, checking proc-macro crates or build.rs can cause linking errors in rtool.
