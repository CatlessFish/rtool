...
#[macro_export]
macro_rules! rtool_trace {
    ($($arg:tt)+) => (
        ::log::trace!(target: "rtool", $($arg)+)
    );
}

#[macro_export]
macro_rules! rtool_debug {
    ($($arg:tt)+) => (
        ::log::debug!(target: "rtool", $($arg)+)
    );
}

#[macro_export]
macro_rules! rtool_info {
    ($($arg:tt)+) => (
        ::log::info!(target: "rtool", $($arg)+)
    );
}

#[macro_export]
macro_rules! rtool_warn {
    ($($arg:tt)+) => (
        ::log::warn!(target: "rtool", $($arg)+)
    );
}

#[macro_export]
macro_rules! rtool_error {
    ($($arg:tt)+) => (
        ::log::error!(target: "rtool", $($arg)+)
    );
}
